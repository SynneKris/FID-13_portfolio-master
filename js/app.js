...
async function getPost(pageValue) {
    ...
    const post = await fetch(`https://14m8q60u.api.sanity.io/v1/data/query/production?query=*
...
async function getPosts() {
    ...
    // NB. = projectID variable kommer fra env.js fil
    const posts =  await fetch(`https://14m8q60u.api.sanity.io/v1/data/query/production?query=*
    [_type == "post"]
    `);
